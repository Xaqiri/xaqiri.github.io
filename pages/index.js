// Temp portfolio because the previous one was 6+ years old
// Copied from developedbyed: https://www.youtube.com/watch?v=k-Pi5ZMxHWY&t=566s
// Rewriting soon, Nextjs is unnecessary
        ...
        <section className='min-h-screen'>
          ...
          <div className='text-center p-10'>
            ...
            <p className='text-md py-5 leading-8 text-gray-800 md:text-xl max-w-xl mx-auto dark:text-gray-200'>
              Pursuing a Bachelor of Science in Software Engineering from
              Southern New Hampshire University. Interested in web development,
              data engineering, and computational linguistics.
            </p>
          </div>
        ...
        <section>
          <div>
            ...
            <p className='text-md leading-8 text-gray-800 dark:text-gray-200'>
              Web development with React, Python, Django, Java, Spring,
          ...
          <div className='lg:flex gap-10'>
            <div className='text-center shadow-lg p-10 rounded-xl my-10 text-gray-800 dark:bg-gray-200'>
              ...
              <h3 className='text-lg font-medium pt-8 pb-2'>
                <a
                  ...
                  href='https://github.com/Xaqiri/PythonFlashcards'
                >
                  Flashcards
                </a>
              </h3>
            ...
            <div className='text-center shadow-lg p-10 rounded-xl my-10 text-gray-800 dark:bg-gray-200'>
              ...
              <h3 className='text-lg font-medium pt-8 pb-2'>
                <a
                  className='text-teal-600'
                  href='https://topmembersonly.up.railway.app'
                >
                  Message Board
                </a>
              </h3>
              <p className='py-2'>
                Simple message board written in Javascript with Node and Express
                connected to a MongoDB database.
                <p>
                  User authentication with passport.js and password encryption
                  with bcrypt
                </p>
              </p>
            </div>
            <div className='text-center shadow-lg p-10 rounded-xl my-10 text-gray-800 dark:bg-gray-200'>
              ...
              <h3 className='text-lg font-medium pt-8 pb-2'>
                <a
                  className='text-teal-600'
                  href='https://github.com/Xaqiri/VampyrManor'
                >
                  Vampyr Manor
                </a>
              </h3>
              <p className='py-2'>
                Roguelike written in Python + Pygame connected to a Sqlite
                database
              </p>
            </div>
          </div>
